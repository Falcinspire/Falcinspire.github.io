let settingsFile = `# Will be printed at the top of each page
title = "Hackpack"
...
# Golang-style regexes of files to ignore. 
# Regexes can be tested on https://regex101.com/
# ==============================================
...
# Number of columns the the document is split into. 
# This will affect both the main body and the index
columns = 3

# Settings that affect the size of the text in 
# different areas of the document. These are in mm
code_font_size = 6
header_font_size = 10
index_font_size = 8`

document.getElementById('default-content').innerHTML = settingsFile